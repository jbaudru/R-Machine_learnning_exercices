...
Yhat1=treeL(Xtr,Ytr,Xtr,1)
Yhat2=treeL(Xtr,Ytr,Xtr,5)
Yhat3=treeL(Xtr,Ytr,Xtr,10)
...
print(paste("Training 2 MISEloo:", MISE_loo(Xtr, Ytr, 5)))
print(paste("Training 3 MISEloo:", MISE_loo(Xtr, Ytr, 10)))
